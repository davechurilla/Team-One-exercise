...
When asked to advance to the second stage of the interview process for an open Senior Web Developer position, Lead UI Architect Rodolfo Dengo at Team One provided me with the following UI Code Exercise assignment requirements: 
...
- Gulp: Task manager that runs testing and optimization tools when watching, and on final build. LiveReload runs while watching files and will validate code and launch/refresh browser at localhost:9000 on each save.
- htmlmin, cssnano, uglify, imagemin - Optimization tools for compression of files when creating a build.

The fonts used on the page were downloaded from [Google Fonts](https://fonts.google.com/) and converted using the [Font Squirrel website](https://www.fontsquirrel.com/). All font file types needed for full browser cross-compatibility are imported into the main SCSS file as a dependency. Lastly, I think it goes without saying the source used for the images featured in the galleries all come from the ever-popular image placeholder service, [PlaceKitten.com](http://www.placekitten.com).

### HTML5

Clean, simple and standards-compliant mark-up was written first to frame up the structure of the page. Use of the semantic HTML approach results in clearly delineated code that will help with ease of readability and editing. Type, order, and names of tags, along with organized commenting and spacing in code all contribute to adherence standards that make for scalable, clean HTML. Organized naming convention for IDs and class names create a clean, efficient environment for next steps of authoring the CSS and Javascript code.
...
<table>
	<tr>
		...
		<td valign="top">
			I am a successful technology professional with proven experience in front end web application development. My primary roles on previous projects include full stack front end development, working on large enterprise-level websites for Mattel, Toyota, AARP and Bloomin’ Brands.<br /><br />
			...
			<ul>
			 ...
			 Please review <a href="http://portfolio.davechurilla.com" target="_blank">my portfolio</a> and download <a href="http://portfolio.davechurilla.com/DAVE_CHURILLA_Resume.pdf">my resume</a> for more details regarding my experience and skills. My current contact information can be found on my resume as well. Thanks again!
		</td>
	</tr>
</table>
